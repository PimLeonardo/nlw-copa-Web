...
export default function Home(props: HomeProps) {
  ...
  async function createPool(event: FormEvent) {
    ...
    try {
      ...
      alert("Bolão criado com sucesso, seu código foi copiado para a área de trasferência")
      ...
      <main>
        ...
        <div className="mt-10 flex items-center gap-2">
          ...
          <strong className="text-gray-100 text-xl">
            <span className="text-emphasis-500">+{props.usersCount}</span> pessoas já estão usando
          </strong>
        </div>
        ...
        <p className="mt-4 text-sm text-gray-300 leading-relexed">
          Após criar seu bolão, você receberá um código único que poderá usar para convidar amigos.
        </p>
